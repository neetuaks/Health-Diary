    ...
    <Modal visible={visible} animationType="slide" transparent>
      <View style={styles.backdrop}>
        <Card style={styles.dialog}>
          ...
          <Button label="Merge (keep existing, add/replace by id)" onPress={() => onChoose('merge')} style={{ marginTop: spacing.md }} />
          <Button label="Replace (delete existing and restore)" variant="destructive" onPress={() => onChoose('replace')} style={{ marginTop: spacing.sm }} />
