...
describe('Google Drive backup helpers', () => {
  ...
  test('listBackupsFromDrive calls Drive API and returns files', async () => {
    ...
    (global as any).__EXPO_SECURE_STORE_STORE = (global as any).__EXPO_SECURE_STORE_STORE || {};
    (global as any).__EXPO_SECURE_STORE_STORE['healthdiary_google_drive_token_v2'] = JSON.stringify({ accessToken: 'tok123', expiresAt: Date.now() + 10000 });
